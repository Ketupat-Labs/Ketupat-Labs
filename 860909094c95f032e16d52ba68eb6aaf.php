            ...
            <?php if($isTeacher): ?>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <form method="GET" action="<?php echo e(route('activity.index')); ?>" class="flex items-center gap-4">
                        ...
                        <div class="p-6 bg-white border-b border-gray-200">
                            ...
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <div class="flex gap-2">
                                    <a href="<?php echo e(route('activity.index', array_merge(request()->all(), ['month' => $prevMonth, 'year' => $prevYear]))); ?>"
                                        class="px-3 py-1 text-sm border rounded hover:bg-gray-50 text-gray-600 no-underline">
                                        ← Sebelum
                                    </a>
                                    <a href="<?php echo e(route('activity.index', array_merge(request()->all(), ['month' => date('n'), 'year' => date('Y')]))); ?>"
                                        class="px-3 py-1 text-sm border rounded hover:bg-gray-50 text-gray-600 no-underline">
                                        Hari Ini
                                    </a>
                                    <a href="<?php echo e(route('activity.index', array_merge(request()->all(), ['month' => $nextMonth, 'year' => $nextYear]))); ?>"
                                        class="px-3 py-1 text-sm border rounded hover:bg-gray-50 text-gray-600 no-underline">
                                        Seterusnya →
                                    </a>
                                </div>
                ...
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <?php if($isTeacher && $selectedClass): ?>
                        ...
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                            <div class="p-6 bg-white border-b border-gray-200">
                                <h3 class="font-bold text-gray-900 mb-4">Tetapkan Tarikh Akhir</h3>
                                ...
                                <form action="<?php echo e(route('activity.store')); ?>" method="POST">
                                    ...
                                    <div class="mb-4">
                                        <label for="lesson_id" class="block text-sm font-medium text-gray-700 mb-1">Pilih
                                            Pelajaran</label>
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 bg-white border-b border-gray-200">
                            <h3 class="font-bold text-gray-900 mb-4">Pelajaran Terkini</h3>

                            <?php $__empty_1 = true; $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php
                                    $eventMonth = date('n', strtotime($event['start']));
                                ?>
                                <?php if($eventMonth == date('n')): ?>
                                        ...
                                        <div class="flex justify-between items-start">
                                            <div>
                                                ...
                                                <p class="text-xs text-gray-500">Tarikh Akhir:
                                                    <?php echo e(date('d M Y', strtotime($event['start']))); ?>
                                            ...
                                            <span
                                                class="bg-red-100 text-red-800 text-xs font-semibold px-2 py-0.5 rounded">Padam</span>
                                        </div>
                                    </div>
                                <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <p class="text-sm text-gray-500 text-center py-4">Tiada aktiviti bulan ini.</p>
                            <?php endif; ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\Material\resources\views/activity/index.blade.php ENDPATH**/ ?>