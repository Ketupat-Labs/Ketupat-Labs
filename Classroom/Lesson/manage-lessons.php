...
<head>
    ...
    <title>Manage Lessons - CompuPlay</title>
...
<body class="font-sans antialiased bg-gray-50">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                            ...
                            <a href="manage-lessons.php" class="inline-flex items-center px-1 pt-1 border-b-2 border-blue-500 text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-blue-700 transition duration-150 ease-in-out">
                                Classroom
                            </a>
        ...
        <main class="py-8 bg-gradient-to-b from-gray-50 to-white min-h-screen">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 px-4 sm:px-0 gap-4">
                    <div>
                        <h1 class="text-3xl font-extrabold text-[#2454FF] tracking-tight">Lessons Inventory</h1>
                        <p class="text-gray-600 mt-2">Create and manage your lesson content for students</p>
                    </div>
                    <a href="create-lesson.php" class="bg-[#5FAD56] hover:bg-green-700 text-white font-bold py-3 px-6 rounded-lg transition ease-in-out duration-150 shadow-md hover:shadow-lg flex items-center gap-2">
    ...
    <script src="JS/manage-lessons.js"></script>
    <script>
