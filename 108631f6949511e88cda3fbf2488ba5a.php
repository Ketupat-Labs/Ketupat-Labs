    ...
    <div class="py-12 bg-gray-50" x-data="{ activeTab: 'lessons' }">
        <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 px-4 sm:px-0 gap-4">
                ...
                <a :href="activeTab === 'lessons' ? '<?php echo e(route('lessons.create')); ?>' : '<?php echo e(route('activities.create')); ?>'"
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $lessons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lesson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <?php echo e($lesson->duration ?? 'N/A'); ?> minit</td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <a href="<?php echo e(route('assignments.create', ['lesson_id' => $lesson->id])); ?>"
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\Ketupat-Labs-main\Ketupat-Labs-main\resources\views/lessons/index.blade.php ENDPATH**/ ?>