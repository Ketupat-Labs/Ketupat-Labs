                    ...
                    <form method="POST" action="<?php echo e(route('assignments.store')); ?>">
                        ...
                        <div class="mb-6">
                            ...
                            <select name="classroom_id" id="classroom_id"
                                ...
                                <?php $__currentLoopData = $classrooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classroom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($classroom->id); ?>"><?php echo e($classroom->name); ?> (<?php echo e($classroom->subject); ?>)
                                    </option>
                        ...
                        <div class="flex items-center justify-end mt-4">
                            <button type="submit"
                                ...
                                <?php echo e(__('Assign Selected Lessons')); ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\Material\resources\views/assignments/create.blade.php ENDPATH**/ ?>