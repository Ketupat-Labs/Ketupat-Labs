        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-compuplay-gray">Completed Lessons</p>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold mt-2" style="color: #FFBA08;">
                                    ...
                                    <h4
                                        class="text-lg font-bold text-gray-800 mb-1 group-hover:text-blue-600 transition-colors">
                                        {{ $classroom->name }}
                                    </h4>
                                    <p class="text-sm text-gray-500 mb-4">{{ $classroom->subject }}</p>
                                    <div class="pt-4 border-t border-gray-100 flex justify-between items-center">
                                        <span class="text-xs text-gray-400">Enrolled:
                                            {{ $classroom->pivot->enrolled_at ? \Carbon\Carbon::parse($classroom->pivot->enrolled_at)->format('M d, Y') : 'N/A' }}</span>
                                        <a href="{{ route('classrooms.show', $classroom) }}"
                                            class="text-blue-600 text-sm font-medium hover:underline">View Class
                                            &rarr;</a>
                                    </div>
                                </div>
                            @endforeach
                    ...
                    @else
                        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8 text-center">
                            ...
                            <p class="text-gray-500 mb-6">You haven't been enrolled in any classes yet.</p>
                        </div>
                    @endif
                </div>

                <!-- Main Action Cards (Quick Access) -->
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <a href="{{ route('lesson.index') }}"
                            ...
                            <div class="p-6 text-white"
                                ...
                                <div class="flex items-center justify-between mb-4">
                                    <svg class="w-12 h-12 opacity-90" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253">
                                        </path>
                                ...
                                <p class="text-sm opacity-90">Browse and access all available lessons
                                </p>
                            </div>
                            <div class="p-6">
                                <div class="flex items-center text-sm" style="color: #969696;">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" <svg
                                            class="w-12 h-12 opacity-90" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="p-6">
                                <div class="flex items-center text-sm" style="color: #969696;">
                                    ...
                                    <span>{{ \App\Models\QuizAttempt::where('user_id', $user->id)->count() }}
                                        attempts</span>
                                </div>
                            </div>
                        </a>
                        ...
                        <a href="{{ route('submission.show') }}"
                            class="group bg-white rounded-xl shadow-sm border-2 border-transparent hover:shadow-lg transition-all duration-300 overflow-hidden"
                            onmouseover="this.style.borderColor='#FFBA08'"
                            onmouseout="this.style.borderColor='transparent'">
                            <div class="p-6 text-white"
                                style="background: linear-gradient(to bottom right, #FFBA08, #d99e07);">
                                <div class="flex items-center justify-between mb-4">
                                    <svg class="w-12 h-12 opacity-90" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="p-6">
                                <div class="flex items-center text-sm" style="color: #969696;">
                                    ...
                                    <span>{{ \App\Models\Submission::where('user_id', $user->id)->where('status', 'Submitted - Awaiting Grade')->count() }}
                                        pending</span>
                                </div>
                            </div>
                        </a>
                            ...
                            @forelse($recentLessons as $lesson)
                                <a href="{{ route('lesson.show', $lesson->id) }}"
                                    ...
                                    <svg class="w-5 h-5 transition-colors" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24" style="color: #969696;">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M9 5l7 7-7 7">
                                        </path>
                                    </svg>
