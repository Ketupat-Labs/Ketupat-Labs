...
<body>
    ...
    <nav class="navbar">
        <div class="container">
            <div class="nav-brand">
                <img src="{{ asset('assets/images/LogoCompuPlay.jpg') }}" alt="CompuPlay Logo" class="logo-img">
            </div>
            <ul class="nav-menu">
                <li><a href="#features">Ciri-ciri</a></li>
                <li><a href="#about">Tentang</a></li>
                <li><a href="{{ route('login') }}" class="btn-login-nav">Log Masuk</a></li>
            </ul>
            <div class="hamburger">
                <span></span>
                <span></span>
    ...
    <section class="hero">
        ...
        <div class="container">
            ...
            <div class="hero-image">
                <img src="{{ asset('assets/images/hero-education.svg') }}" alt="Education Platform">
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="about-content">
                ...
                <div class="about-image">
                    <img src="{{ asset('assets/images/picture1.jpg') }}" alt="About Platform">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-section">
                    <h3><img src="{{ asset('assets/images/LogoCompuPlay.jpg') }}" alt="CompuPlay Logo" class="footer-logo"></h3>
