            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100">
                <div class="p-8 bg-white">
                    <div class="text-center mb-8">
                        ...
                        <h3 class="text-2xl font-bold text-gray-900">Kemaskini Maklumat Kelas</h3>
                        <p class="text-sm text-gray-500 mt-1">Sila kemaskini maklumat kelas anda.</p>
                    </div>

                    <form method="POST" action="{{ route('classrooms.update', $classroom) }}" 
                          x-data="{
                              name: '{{ old('name', $classroom->name) }}',
