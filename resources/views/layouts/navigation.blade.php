<nav x-data="{ open: false }" class="bg-white border-b-2 border-compuplay-blue/20 shadow-sm">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center space-x-3">
                        <x-application-logo class="block h-10 w-auto fill-current text-compuplay-blue" />
                        <span class="text-xl font-bold text-compuplay-dark-gray hidden sm:block">CompuPlay</span>
                    </a>
                </div>
