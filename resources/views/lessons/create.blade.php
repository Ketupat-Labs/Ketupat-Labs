            ...
            <form method="POST" action="{{ route('lessons.store') }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <select name="topic" id="topic" required
                        ...
                        <option value="HCI" {{ old('topic') == 'HCI' ? 'selected' : '' }}>3.1 Interaction Design</option>
                        <option value="HCI_SCREEN" {{ old('topic') == 'HCI_SCREEN' ? 'selected' : '' }}>3.2 Screen Design</option>
                        <option value="Algorithm" {{ old('topic') == 'Algorithm' ? 'selected' : '' }}>Other: Algorithms</option>
                    </select>
                </div>
