...
<div class="py-8 bg-gray-50 min-h-screen">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Cipta Pelajaran Baharu</h1>
                <p class="mt-2 text-sm text-gray-600">Isi metadata terlebih dahulu, kemudian bina kandungan pelajaran anda</p>
            </div>
