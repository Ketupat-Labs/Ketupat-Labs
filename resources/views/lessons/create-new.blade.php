<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('lessons.index') }}"
                class="text-gray-600 hover:text-gray-900 font-medium flex items-center gap-2 text-sm">
    ...
    <div class="py-12 bg-gray-50 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <p class="mb-8 text-sm text-gray-600">Isi metadata terlebih dahulu, kemudian bina kandungan pelajaran anda
            </p>
            ...
            <form method="POST" action="{{ route('lessons.store') }}" class="space-y-8">
                @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="title" id="title" required
                                ...
                                value="{{ old('title') }}" placeholder="Gunakan tajuk yang deskriptif">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="topic" id="topic" list="topics" required
                                class="block w-full border-gray-300 rounded-lg shadow-sm p-3 focus:border-blue-500 focus:ring focus:ring-blue-500/20 transition"
                                value="{{ old('topic') }}" placeholder="Pilih atau taip topik">
                            <datalist id="topics">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" name="duration" id="duration" min="5"
                                class="block w-full border-gray-300 rounded-lg shadow-sm p-3 focus:border-blue-500 focus:ring focus:ring-blue-500/20 transition"
                                value="{{ old('duration') }}" placeholder="cth., 45">
                        </div>
                    ...
                    <div>
                        ...
                        <input type="file" name="material" id="material" class="block w-full text-sm text-gray-600
                                  file:mr-4 file:py-2 file:px-4
                                  file:rounded-lg file:border-0
                                  file:text-sm file:font-semibold
                                  file:bg-blue-50 file:text-blue-700
                                  hover:file:bg-blue-100 transition">
                        <p class="mt-2 text-xs text-gray-500">Muat naik PDF, dokumen, atau bahan pembelajaran lain
                            (Maksimum 25MB)</p>
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    <div class="border-l-4 border-green-500 pl-4">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Bina pelajaran anda menggunakan blok - tambah teks, tajuk,
                            imej, video, dan permainan interaktif</p>
                    </div>
                ...
                <div class="flex items-center justify-between pt-6 border-t border-gray-300">
                    ...
                    <button type="submit"
                        class="bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-8 rounded-lg shadow-md hover:shadow-lg transition duration-150 flex items-center gap-2">
