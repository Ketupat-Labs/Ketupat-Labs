                        ...
                        <div class="space-y-6">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $timelineItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <div class="relative pl-8 border-l-2 border-gray-200 pb-6 last:pb-0 last:border-0">
                                    ...
                                    <div
                                        class="absolute -left-[9px] top-0 bg-white border-4 <?php echo e($isActivity ? 'border-purple-600' : 'border-[#2454FF]'); ?> h-4 w-4 rounded-full">
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div class="flex justify-between items-start">
                                            <div>
                                                <h4 class="text-lg font-bold text-gray-800 <?php echo e($isActivity ? 'hover:text-purple-600' : 'hover:text-[#2454FF]'); ?> transition">
                                                    <?php if($isActivity): ?>
                                                        <a href="<?php echo e(route('activities.show', $item->activity)); ?>"><?php echo e($item->activity->title); ?></a>
                                                        <span class="text-xs font-normal text-gray-500 ml-1">(<?php echo e($item->activity->suggested_duration); ?>)</span>
                                                    <?php else: ?>
                                                        <a href="<?php echo e(route('lesson.show', $item)); ?>"><?php echo e($item->title); ?></a>
                                                    <?php endif; ?>
                                                </h4>
                                                <?php if($isActivity): ?>
                                                     <p class="text-sm text-gray-500 mb-2"><?php echo e($item->activity->type); ?> &bull; Assigned <?php echo e($item->created_at->format('M d, Y')); ?></p>
                                                     <p class="text-gray-600 text-sm mb-4"><?php echo e(Str::limit($item->activity->description, 120)); ?></p>
                                                     <?php if($item->due_date): ?>
                                                        <p class="text-xs text-red-500 font-bold">Due: <?php echo e(\Carbon\Carbon::parse($item->due_date)->format('M d, Y')); ?></p>
                                                     <?php endif; ?>
                                                <?php else: ?>
                                                    <p class="text-sm text-gray-500 mb-2"><?php echo e($item->topic); ?> &bull; Posted
                                                        <?php echo e($item->created_at ? $item->created_at->format('M d, Y') : 'N/A'); ?></p>
                                                    <p class="text-gray-600 text-sm mb-4">
                                                        <?php echo e(Str::limit($item->content, 120)); ?></p>
                                                <?php endif; ?>
                                            </div>
                                            ...
                                            <?php if($user->role === 'teacher'): ?>
                                                <?php if(!$isActivity): ?>
                                                    <div class="bg-blue-100 text-[#2454FF] text-xs font-bold px-2 py-1 rounded whitespace-nowrap ml-2">
                                                        <?php echo e($item->submissions->whereIn('user_id', $classroom->students->pluck('id'))->count()); ?>
                                        ...
                                        <div class="flex space-x-3 mt-2">
                                            <?php if($isActivity): ?>
                                                <a href="<?php echo e(route('activities.show', $item->activity)); ?>"
                                                    class="text-sm font-semibold text-purple-600 hover:underline">
                                                    View Details
                                                </a>
                                            <?php else: ?>
                                                <a href="<?php echo e(route('lesson.show', $item)); ?>"
                                                    class="text-sm font-semibold text-[#2454FF] hover:underline">
                                                    <?php echo e($user->role === 'student' && ($item->enrollments->first()->status ?? '') === 'completed' ? 'Review Lesson' : 'Open Lesson'); ?>

                                                </a>
                                                <?php if($user->role === 'teacher'): ?>
                                                    <span class="text-gray-300">|</span>
                                                    <a href="<?php echo e(route('submission.index', ['lesson_id' => $item->id, 'classroom_id' => $classroom->id])); ?>"
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\CompuPlay\resources\views/classrooms/show.blade.php ENDPATH**/ ?>