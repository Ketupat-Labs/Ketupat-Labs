...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-bold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Cipta Kelas Baru')); ?>
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100">
                <div class="p-8 bg-white">
                    ...
                    <form method="POST" action="<?php echo e(route('classrooms.store')); ?>" 
                          x-data="{
                              name: '',
                              existingNames: <?php echo \Illuminate\Support\Js::from($existingNames)->toHtml() ?>,
                              isDuplicate: false,
                              checkDuplicate() {
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\Material\resources\views/classrooms/create.blade.php ENDPATH**/ ?>