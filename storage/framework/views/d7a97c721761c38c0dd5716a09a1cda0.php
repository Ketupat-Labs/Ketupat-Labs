...
<body>
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6 sm:gap-3">
                    ...
                    <div class="relative">
                        ...
                        <div id="userMenu"
                            ...
                            <a href="<?php echo e(route('settings.index')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Tetapan</a>
    ...
    <script src="<?php echo e(asset('Forum/JS/post-detail.js')); ?>"></script>
    <script>
...
<?php /**PATH C:\xampp\htdocs\Material\resources\views/forum/post-detail.blade.php ENDPATH**/ ?>